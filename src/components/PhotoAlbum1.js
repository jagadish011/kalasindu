  ...
  return (
    <Container>
      ...
      <p style={{ fontFamily: "Open Sans", marginBottom: "40px" }}>
        Guru Poornima Gururaja's vision for Kalasindhu has not just been to
        teach students and perform but also to curate festivals and platforms
        where artists from all walks of life and from all around the globe are
        invited to perform and give Students of Art and Rasikas a deeper insight
        into their journey in Arts . With that moral ground Kalasindhu currently
        curates 2 major festivals- Nirantara Narmada & Navarasa Navarathri
      </p>
      <Row>
